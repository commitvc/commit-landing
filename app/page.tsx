  ...
  return (
    <>
      <header className="sr-only">
        ...
        <p>
          Active Fund I commitments to date: 8 — three announced (UMA — humanoid robotics, Macrodata
          Labs — training-data infrastructure, ZML — AI inference), five stealth (disclosure
          pending).
        </p>
        <p>
